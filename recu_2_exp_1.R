...
exp <- '1' #entrenar el baseline exactamente igual pero concatenando el dataset viejo sin delinquency y subsampleado a la misma proporcion de SI que el nuevo
